 ...
 * @param fsr:0 代表 ±250dps; 1 代表±500dps;2 代表 ±1000dps;3 代表±2000dps
 * @return u8 0 if success, otherwise.
 */
 ...
 * @brief 得到陀螺仪值(原始值)
 *
 * @param gx  陀螺仪 x 轴的原始读数(带符号)
 * @param gy  陀螺仪 y 轴的原始读数(带符号)
 * @param gz  陀螺仪 z 轴的原始读数(带符号)
 * @return u8 0-成功
 */
 ...
 * @brief 得到加速度值(原始值)
 *
 * @param ax 加速度计 x 轴的原始读数(带符号)
 * @param ay 加速度计 y 轴的原始读数(带符号)
 * @param az 加速度计 z 轴的原始读数(带符号)
 * @return u8 0-成功
 */
